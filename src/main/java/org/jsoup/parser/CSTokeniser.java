...
public class CSTokeniser {
	...
	private CSTokeniserState state = CSTokeniserState.Data; // current tokenisation state
	...
	CSTokeniser(CharacterReader reader, ParseErrorList errors) {
		this.reader = reader;
		this.errors = errors;
	}
	...
	CSTokeniserState getState() {
		return state;
	}

	void transition(CSTokeniserState state) {
		this.state = state;
	}

	void advanceTransition(CSTokeniserState state) {
		reader.advance();
		this.state = state;
	}
